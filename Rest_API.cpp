...
public:
    ...
    void GET_api_states(std::string entity_id){ //E.G. sensor.kitchen_temperature
        CURL *curl;
        struct curl_slist *list = NULL;
        CURLcode res;
    ...
    void GET_api_camera_proxy(std::string camera_entity_id){ //E.G. camera.my_sample_camera
        CURL *curl;
        struct curl_slist *list = NULL;
        CURLcode res;
